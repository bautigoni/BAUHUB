    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          height: 900,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(75,227,255,0.16) 0%, rgba(75,227,255,0.06) 30%, transparent 65%)',
          filter: 'blur(40px)',
          mixBlendMode: 'screen',
          pointerEvents: 'none',
          zIndex: 1,
      ...
      <div
        ...
        style={{
          ...
          height: 500,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(75,227,255,0.28) 0%, rgba(75,227,255,0.08) 40%, transparent 70%)',
          filter: 'blur(20px)',
          mixBlendMode: 'screen',
          pointerEvents: 'none',
          zIndex: 1,
